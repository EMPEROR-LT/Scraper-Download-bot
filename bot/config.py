...
class Config:
    ...
    MONGO_URI = "mongodb+srv://ltarak570_db_user:zAIRPn92DgjoVZsl@cluster0.bmrg5lf.mongodb.net/?appName=Cluster0"
    CHANNEL_ID = -1002935398927  # Replace with your Channel ID
